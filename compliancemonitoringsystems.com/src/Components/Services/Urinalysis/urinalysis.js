    ...
    return (
      <div>
        ...
        <p>
          ...
          <br />
          <br />
          Compliance Monitoring Systems began providing urinalysis services to
          Western Montana utilizing the Siemens Viva E Analyzer in 2012.
          Siemens’ Laboratories operate in 95% of all hospitals in the State of
          Montana and they are the industry leader with regards to the criminal
          justice system. In 2019 CMS made the switch to use Cordant-Sentry's
          program to utilize the hight complexity of GC/MS and LC/MS/MS to
          provide maximum accuracy and reliability.
          <br />
          <br />
