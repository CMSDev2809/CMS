...
function Header() {
  ...
  return <img alt={""} src={logo} alt="Logo" />;
}
...
render() {
  ...
  return <img alt={""} src={process.env.PUBLIC_URL + '/img/logo.png'} />;
}
```
...
<img alt={""} src="http://i.imgur.com/HUjEr9l.png" width="500" alt="gh-pages branch setting">
